...
from models import MissionCreate, MissionInfo
...
async def start_mission(body: MissionCreate) -> Dict[str, Any]:
    ...
    from services.digital_twin import get_digital_twin_service
    ...
    async def process_and_store(frame: Dict[str, Any]) -> None:
        ...
        try:
            from websocket_handler import broadcast_frame
...
async def stop_mission(mission_id: str) -> Dict[str, Any]:
    ...
    from services.simulator import get_simulator
    from database import flush_telemetry
